...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen max-h-screen px-4 sm:px-4 md:px-6 overflow-hidden bg-white dark:bg-[#0e0e10] text-gray-900 dark:text-white">
      ...
      <div className="relative container mx-auto px-6 sm:px-10 py-16 lg:py-20 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="w-full max-w-md h-[360px] bg-white/5 border border-gray-300/10 rounded-xl shadow-xl backdrop-blur-md flex items-center justify-center">
