...
const FAQSection = () => {
  ...
  return (
    <section className="pt-20 bg-gray-50 dark:bg-[#0e0e10] text-gray-900 dark:text-white/90 relative z-10">
  ...
  return (
    ...
    >
      <button
        ...
        className="w-full flex justify-between items-center px-6 py-5 text-left text-lg font-semibold text-gray-800 dark:text-white tracking-tight transition-colors duration-300"
      >
